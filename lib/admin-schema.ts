...
export const COLLECTIONS: Record<string, Collection> = {
  ...
  projects: {
    ...
    fields: [
      ...
      { key: "category", label: "Category", type: "text", help: "Short domain label for the card chip" },
      { key: "role", label: "My role", type: "textarea", help: "Shown in the ROLE box on case studies" },
      { key: "metrics", label: "Metric tiles", type: "list", help: "One per line, written as: value | label" },
  ...
  posts: {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "text",
        help: "Required by Pexels when the cover came from there. Clearing it removes the credit line.",
      },
      { key: "cover_credit_url", label: "Photographer URL", type: "text" },
      { key: "cover_source_url", label: "Photo page URL", type: "text" },
